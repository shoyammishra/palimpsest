...
- Key files: src/pilot_defects.py, src/pilot_transport.py, docs/experiment_log.md (E-000..E-003), docs/theory.md (K-1..K-5, P-1), docs/design.md (v0.4), docs/decision_log.md (D-010, D-011), docs/findings.md (F-001..F-008)
